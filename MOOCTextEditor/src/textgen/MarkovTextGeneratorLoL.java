...
public class MarkovTextGeneratorLoL implements MarkovTextGenerator {
    ...
    public void train(String sourceText) {
        ...
        for (int i = 0; i < words.length - 1; i++) {
            processTwoWords(words[i], words[i + 1]);
        }
        processTwoWords(words[words.length - 1], words[0]);
    }

    /**
     * process each adjacent two words.
     * @param prevWord first word to process.
     * @param currWord second word to process.
     */
    private void processTwoWords(String prevWord, String currWord) {
