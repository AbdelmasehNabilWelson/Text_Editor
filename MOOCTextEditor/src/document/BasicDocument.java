...
//		System.out.println("words in the string " + this.getText());
//		for(String word : words) {
//			System.out.println(word);
//		}
//		System.out.println("End of words, And the number of words = " + words.size());
...
//
//		System.out.println("Sentences in the string " + this.getText());
//		for(String sent : sentences) {
//			System.out.println(sent);
//		}
//		System.out.println("End of sentences, And the number of sentences = " + sentences.size());
	...
	public int getNumSyllables() {
		...
		//System.out.println("Start of Syllables");
		String[] words = this.getText().split("\\P{L}+");
		int totalVowels = 0;
		for(String word : words) {
			//System.out.println(word + ", the number of Vowels = " + countSyllables(word));
			totalVowels += super.countSyllables(word);
		}
